(function ($) {
  ...
  $(document).ready(function () {
    ...
    var bannerSlider = new Swiper(".banner-slider", {
      slidesPerView: 1,
      loop: true,
      speed: 1000, // Faster transition (was 1500)
      effect: "fade", 
      fadeEffect: {
        crossFade: true
      },
      grabCursor: true, // User friendly cursor
      autoplay: {
        delay: 4000, // Faster rotation (was 5000)
        disableOnInteraction: false,
        pauseOnMouseEnter: true, // Pause when user hovers for better UX
      },
      pagination: {
      ...
      on: {
        slideChangeTransitionStart: function () {
          $('.banner-slider [data-aos]').removeClass('aos-animate');
        },
        slideChangeTransitionEnd: function () {
          $('.banner-slider .swiper-slide-active [data-aos]').addClass('aos-animate');
        }
      }
    });
    // ==================== banner js end =======================
