            ...
            <div class="col-span-full lg:col-span-12">
                <div class="card p-0">
                    <div class="flex-center-between p-6 pb-4 border-b border-gray-200 dark:border-dark-border">
                        <h3 class="text-lg card-title leading-none">User Edit Form</h3>
                        {{-- <a href="{{ route('user.create') }} "type="button"
                            ...
                            <span class="shrink-0">Add User</span>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <input type="text" id="first_name" class="form-input" placeholder=" Name"
                                        name="name" value="{{ $user->name }}" autocomplete="off" required>
                                    @error('name')
                                ...
                                <div class="mt-2">
                                    ...
                                    <input type="email" id="first_name" class="form-input" placeholder="E-mail"
                                        name="email" value="{{ $user->email }}" autocomplete="off" required>
                                ...
                                {{-- <div class="mt-2">
                                    ...
                                    <i class="bx bx-show password-icon position-absolute top-50 end-0 translate-middle-y p-3 h4"
                                        onclick="togglePasswordVisibility('password-input')"></i>
                                ...
                                {{-- <div class="mt-2">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <i class="bx bx-show password-icon position-absolute top-50 end-0 translate-middle-y p-3 h4"
                                            ...
                                            onclick="togglePasswordVisibility('confirm-password-input')"></i>
