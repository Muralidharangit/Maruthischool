            ...
            <div class="col-span-full">
                <div class="card p-0">
                    <div class="flex-center-between p-6 pb-4 border-b border-gray-200 dark:border-dark-border">
                        <h3 class="text-lg card-title leading-none"> User Management / Permissions</h3>
                        <a href="{{ route('permission.create') }}"type="button"
                            class="btn b-light btn-primary-light btn-sm prism-toggle !py-2.5 focus:bg-primary-500 focus:text-white dark:!bg-dark-icon">
                            <span class="shrink-0">Add Permission</span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            ...
                                            <a href ="{{ route('permission.edit', $permission->id) }}"><i
                                                    class="ri-edit-box-line text-info"></i>
                                            </a>
                                            ...
                                            <form method="post" action="{{ route('permission.delete', $permission->id) }}">
                                                ...
                                                @method('DELETE')
                                                <button
                                            onclick="return confirm('Are you sure you want to delete this item?')"><i class="ri-delete-bin-fill text-danger"></i>
                                        </button>
                                            </form>
